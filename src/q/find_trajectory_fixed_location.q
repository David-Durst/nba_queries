...
time_offset: 5
space_offset: 10
\t sum 0 < {[row]  count select from moments where x_loc within(70; 90), y_loc within(16; 32), time within(row[`time]+time_offset-space_delta; row[`time]+time_offset+space_delta) } each starting_moments
